...
public class SubtractCommand implements Cmd {

  @Override
  public String getUsage() {
    return "/cpe subtract <server/player> <id> <value> (player)";
  }
  ...
  public boolean execute(CustomExpansion ex, CommandSender s, String[] args) {
    ...
    if (args[0].equalsIgnoreCase("server")) {
      ...
      Utils.msg(s, "Subtracted: " + args[2] + " to placeholder: " + id, "New value:" + obj);
      return true;
    }
    return false;
  }
