 ...
 *
 */
package com.extendedclip.papi.expansion.custom.storage;
...
public interface PlayerStorage {
  void init();
  boolean add(PlaceholderPlayer player, Placeholder p);
  boolean remove(PlaceholderPlayer player, String id);
  int load();
}
